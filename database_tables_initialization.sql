...
CREATE TABLE emails (
  ...
  email_direction ENUM ('SENT', 'RECEIVED' ,'DRAFT') DEFAULT 'RECEIVED', -- Email types ( a copy for every user )
  folder ENUM ('GENERAL', 'SPAM', 'TRASH', 'DRAFT', 'ARCHIVE') DEFAULT 'GENERAL' -- Organize emails into folders ( General is either sent or recieved )
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;
